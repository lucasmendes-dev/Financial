            ...
            <form class="space-y-6" action="{{ route('assets.contribuition', $asset->id) }}" method="POST">
                ...
                <div class="flex space-x-4">
                    <div class="w-1/2">
                        ...
                        <input value="{{ $asset->code }}" type="text" name="code" id="code" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="PETR4" required">
                    </div>
                    <div class="w-1/2">
