...
class AssetForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'asset_type': forms.Select(attrs={'class': 'form-control col-md-6', 'placeholder':"Ex: Petrobras"}),     
            'asset_name': forms.TextInput(attrs={'class': 'form-control col-md-12'}),             
            'asset_code': forms.TextInput(attrs={'class': 'form-control col-md-6'}),    
